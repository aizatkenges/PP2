    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                elif event.button == 4: # scroll up changes color
                    mode = 'red'
                elif event.button == 5: # scroll down changes color
                    mode = 'blue'
        ...
        while i < len(points) - 1:
            if draw_mode == 'line':
                ...
                pygame.draw.rect(screen, (255, 255, 255), pygame.Rect(points[i], points[i + 1]), radius)
